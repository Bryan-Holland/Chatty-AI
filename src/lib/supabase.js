 ...
 * PURPOSE: Supabase client singleton — imported everywhere that needs database access
 * EXPORTS: supabase (configured client instance)
 * SESSION 7: Initial setup with project credentials - UPDATED WITH FULL KEY
 */
